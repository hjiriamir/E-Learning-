...
/**
 * CoachingCententQuizQuestionOption
 *
 * @ORM\Table(name="coaching_centent_quiz_question_option", indexes={@ORM\Index(name="IDX_132176B7E62CA5DB", columns={"id_question"})})
 * @ORM\Entity
 */
class CoachingCententQuizQuestionOption
{
    /**
     * @var int
     *
